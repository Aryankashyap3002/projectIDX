...
import projectRouter from './projects.js'; // Import project router

const router = express.Router();

// Mount projects router under workspaces
router.use('/:workspaceId/projects', isAuthenticated, projectRouter);
